...
| `film.html` | Complete seven-cue film on the cinema clock: PCR from one molecule to 1024 copies in 70 seconds, persistent actors, complete poses, RU/EN copy, notes and questions. [Guide](../docs/film.md); scaffold `--template film --palette ocean`; frame review `qa/film/review.cjs` | `tools/build-film.py` |
