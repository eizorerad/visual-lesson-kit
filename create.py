...
def create(destination, title, source_url='', source_label='Источник', lang='ru',
    ...
    if template not in ('gallery', 'methods', 'explanations', 'synthesis', 'molecular', 'molecular-check', 'chemistry-bridge', 'rna-folding', 'rna-prediction', 'trna-journey', 'atac-seq', 'atac-components', 'molecular-views', 'spatial-biology', 'crispri'):
        raise ValueError('Шаблон должен быть gallery, methods, explanations, synthesis, molecular, molecular-check, chemistry-bridge, rna-folding, rna-prediction, trna-journey, atac-seq, atac-components, molecular-views, spatial-biology или crispri.')
    ...
    if template in ('methods', 'explanations', 'synthesis', 'molecular', 'molecular-check', 'chemistry-bridge', 'rna-folding', 'rna-prediction', 'trna-journey', 'atac-seq', 'atac-components', 'molecular-views', 'spatial-biology', 'crispri'):
    ...
    for name in ('START.md', 'authoring.md', 'components.md', 'qa.md', 'provenance.md',
                 ...
                 'chemistry.md', 'physical-chemistry.md', 'chemistry-bridge.md', 'rna-folding.md', 'rna-prediction.md', 'rna-pair-molecule.md', 'cinematic-explanation.md', 'trna-journey.md', 'atac-seq.md', 'atac-components.md', 'atac-verification.md', 'cinema-timeline.md', 'molecular-coordinates.md',
...
def main():
    ...
    parser.add_argument('--template', choices=('gallery', 'methods', 'explanations', 'synthesis', 'molecular', 'molecular-check', 'chemistry-bridge', 'rna-folding', 'rna-prediction', 'trna-journey', 'atac-seq', 'atac-components', 'molecular-views', 'spatial-biology', 'crispri'), default='gallery', help='Галерея, научные методы, связное объяснение, общая карта, молекулярный атлас, проверка молекулярных элементов мост от химии к биологии укладка и предсказание структуры РНК, молекулярный конструктор, ATAC-seq, пространственная биология или CRISPRi')
