...
def create(destination, title, source_url='', source_label='Источник', lang='ru',
    ...
    if template not in ('gallery', 'methods', 'explanations', 'synthesis', 'molecular', 'molecular-check', 'chemistry-bridge', 'rna-folding', 'rna-prediction', 'trna-journey', 'atac-seq', 'atac-components', 'molecular-views', 'spatial-biology'):
        raise ValueError('Шаблон должен быть gallery, methods, explanations, synthesis, molecular, molecular-check, chemistry-bridge, rna-folding, rna-prediction, trna-journey, atac-seq, atac-components, molecular-views или spatial-biology.')
    ...
    if template in ('methods', 'explanations', 'synthesis', 'molecular', 'molecular-check', 'chemistry-bridge', 'rna-folding', 'rna-prediction', 'trna-journey', 'atac-seq', 'atac-components', 'molecular-views', 'spatial-biology'):
...
def main():
    ...
    parser.add_argument('--template', choices=('gallery', 'methods', 'explanations', 'synthesis', 'molecular', 'molecular-check', 'chemistry-bridge', 'rna-folding', 'rna-prediction', 'trna-journey', 'atac-seq', 'atac-components', 'molecular-views', 'spatial-biology'), default='gallery', help='Галерея, научные методы, связное объяснение, общая карта, молекулярный атлас, проверка молекулярных элементов мост от химии к биологии укладка и предсказание структуры РНК, молекулярный конструктор, ATAC-seq, пространственная биология')
